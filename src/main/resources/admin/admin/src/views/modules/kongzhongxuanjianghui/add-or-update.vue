          ...
          <el-form-item class="input" label="规模" prop="guimo">
              <el-input v-model="ruleForm.guimo" 
                placeholder="规模" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="性质" prop="xingzhi">
          <el-input v-model="ruleForm.xingzhi" 
              placeholder="性质" clearable  :readonly="ro.xingzhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="性质" prop="xingzhi">
              <el-input v-model="ruleForm.xingzhi" 
                placeholder="性质" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.xuanchuanshipin" label="宣传视频" prop="xuanchuanshipin">
            <el-button type="text" size="small" @click="download(ruleForm.xuanchuanshipin)">预览</el-button>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="办公地址" prop="bangongdizhi">
          <el-input v-model="ruleForm.bangongdizhi" 
              placeholder="办公地址" clearable  :readonly="ro.bangongdizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="办公地址" prop="bangongdizhi">
              <el-input v-model="ruleForm.bangongdizhi" 
                placeholder="办公地址" readonly></el-input>
                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                        <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="宣讲内容" prop="xuanjiangneirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.xuanjiangneirong" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xuanjiangneirong" label="宣讲内容" prop="xuanjiangneirong">
                    <span v-html="ruleForm.xuanjiangneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.bangongdizhi = true;
            continue;
	            	            ...
	            	            if(o=='xuanjiangneirong'){
            this.ruleForm.xuanjiangneirong = obj[o];
	    this.ro.xuanjiangneirong = true;
            continue;
          }
	                    }
                                                                                                                                                                              }
        ...
        if (data && data.code === 0) {
          var json = data.data;
              		...
              		this.ruleForm.qiyemingcheng = json.qiyemingcheng
                                  		...
                                  		if(json.guimo!=''&&json.guimo){
              		this.ruleForm.guimo = json.guimo
		}
                                  		if(json.xingzhi!=''&&json.xingzhi){
              		this.ruleForm.xingzhi = json.xingzhi
		}
                                  		if(json.tupian!=''&&json.tupian){
          ...
          this.$message.error(data.msg);
                                                                                        ...
                                                                                        // 多级联动参数
                                                                                                                info(id) {
      this.$http({
        url: `kongzhongxuanjianghui/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `kongzhongxuanjianghui/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.kongzhongxuanjianghuiCrossAddOrUpdateFlag = false;
                  this.parent.search();
