  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.touxiang" label="头像" prop="touxiang">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.touxiang.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="居住省份" prop="juzhushengfen">
          <el-input v-model="ruleForm.juzhushengfen" 
              placeholder="居住省份" clearable  :readonly="ro.juzhushengfen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="居住省份" prop="juzhushengfen">
              <el-input v-model="ruleForm.juzhushengfen" 
                placeholder="居住省份" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="居住城市" prop="juzhuchengshi">
          <el-input v-model="ruleForm.juzhuchengshi" 
              placeholder="居住城市" clearable  :readonly="ro.juzhuchengshi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="居住城市" prop="juzhuchengshi">
              <el-input v-model="ruleForm.juzhuchengshi" 
                placeholder="居住城市" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="最高学历" prop="zuigaoxueli">
              <el-input v-model="ruleForm.zuigaoxueli" 
                placeholder="最高学历" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="简历附件" prop="jianlifujian">
          <file-upload
          tip="点击上传简历附件"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.jianlifujian" label="简历附件" prop="jianlifujian">
            <el-button type="text" size="small" @click="download(ruleForm.jianlifujian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
                              </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.touxiang = true;
            continue;
	            	            ...
	            	            if(o=='juzhushengfen'){
            this.ruleForm.juzhushengfen = obj[o];
	    this.ro.juzhushengfen = true;
            continue;
          }
	            	            if(o=='juzhuchengshi'){
            this.ruleForm.juzhuchengshi = obj[o];
	    this.ro.juzhuchengshi = true;
            continue;
          }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                                                                                                          ...
                                                                                                                                                                                          this.dangqianzhuangtaiOptions = "在职,离职,在校生".split(',')
                                                                                                    },
                                                                                                                // 多级联动参数
                                                                                                                                              info(id) {
      this.$http({
