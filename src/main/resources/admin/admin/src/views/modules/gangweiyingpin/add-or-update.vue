      ...
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="行业" prop="xingye">
          <el-input v-model="ruleForm.xingye" 
              placeholder="行业" clearable  :readonly="ro.xingye"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="行业" prop="xingye">
              <el-input v-model="ruleForm.xingye" 
          ...
          <el-form-item class="input" label="城市" prop="chengshi">
              <el-input v-model="ruleForm.chengshi" 
                placeholder="城市" readonly></el-input>
                                                                  ...
                                                                  <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="求职简历" prop="qiuzhijianli">
          <file-upload
          tip="点击上传求职简历"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.qiuzhijianli?ruleForm.qiuzhijianli:''"
          @change="qiuzhijianliUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.qiuzhijianli" label="求职简历" prop="qiuzhijianli">
            <el-button type="text" size="small" @click="download(ruleForm.qiuzhijianli)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="手机" prop="shouji">
              <el-input v-model="ruleForm.shouji" 
                placeholder="手机" readonly></el-input>
                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                        <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="应聘内容" prop="yingpinneirong">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.yingpinneirong" label="应聘内容" prop="yingpinneirong">
                    <span v-html="ruleForm.yingpinneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yingpinneirong = true;
            continue;
          }
	            	            if(o=='qiuzhijianli'){
            this.ruleForm.qiuzhijianli = obj[o];
	    this.ro.qiuzhijianli = true;
            continue;
          }
	            	            if(o=='beizhu'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `gangweiyingpin/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.gangweiyingpinCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    back() {
      ...
      this.parent.contentStyleChange();
                                                                                                ...
                                                                                                qiuzhijianliUploadChange(fileUrls) {
                this.ruleForm.qiuzhijianli = fileUrls;
				this.addEditUploadStyleChange()
            },
                                                                                                	addEditStyleChange() {
	  this.$nextTick(()=>{
