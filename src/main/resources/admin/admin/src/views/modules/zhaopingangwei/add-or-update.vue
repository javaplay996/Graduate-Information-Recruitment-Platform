        ...
        <div v-else>
          <el-form-item class="input" label="联系电话" prop="lianxidianhua">
            ...
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.gangweijieshao" label="岗位介绍" prop="gangweijieshao">
                    <span v-html="ruleForm.gangweijieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `zhaopingangwei/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zhaopingangweiCrossAddOrUpdateFlag = false;
                  this.parent.search();
