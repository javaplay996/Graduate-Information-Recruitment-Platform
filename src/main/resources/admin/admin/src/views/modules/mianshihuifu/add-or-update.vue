  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="面试标题" prop="mianshibiaoti">
              <el-input v-model="ruleForm.mianshibiaoti" 
                placeholder="面试标题" readonly></el-input>
                                                                  ...
                                                                  <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="回复附件" prop="huifufujian">
          <file-upload
          tip="点击上传回复附件"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.huifufujian" label="回复附件" prop="huifufujian">
            <el-button type="text" size="small" @click="download(ruleForm.huifufujian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="手机" prop="shouji">
              <el-input v-model="ruleForm.shouji" 
                placeholder="手机" readonly></el-input>
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="面试回复" prop="mianshihuifu">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.mianshihuifu" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.mianshihuifu" label="面试回复" prop="mianshihuifu">
                    <span v-html="ruleForm.mianshihuifu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.mianshibiaoti = true;
            continue;
	            	            ...
	            	            if(o=='mianshihuifu'){
            this.ruleForm.mianshihuifu = obj[o];
	    this.ro.mianshihuifu = true;
            continue;
          }
	            	            if(o=='huifufujian'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `mianshihuifu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.mianshihuifuCrossAddOrUpdateFlag = false;
                  this.parent.search();
