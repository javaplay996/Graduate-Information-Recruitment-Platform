<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="面试标题" prop="mianshibiaoti">
          <el-input v-model="ruleForm.mianshibiaoti" 
              placeholder="面试标题" clearable  :readonly="ro.mianshibiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="面试标题" prop="mianshibiaoti">
              <el-input v-model="ruleForm.mianshibiaoti" 
                placeholder="面试标题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="面试附件" prop="mianshifujian">
          <file-upload
          tip="点击上传面试附件"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.mianshifujian?ruleForm.mianshifujian:''"
          @change="mianshifujianUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.mianshifujian" label="面试附件" prop="mianshifujian">
            <el-button type="text" size="small" @click="download(ruleForm.mianshifujian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="企业编号" prop="qiyebianhao">
          <el-input v-model="ruleForm.qiyebianhao" 
              placeholder="企业编号" clearable  :readonly="ro.qiyebianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="企业编号" prop="qiyebianhao">
              <el-input v-model="ruleForm.qiyebianhao" 
          ...
          <el-form-item class="input" label="专业" prop="zhuanye">
              <el-input v-model="ruleForm.zhuanye" 
                placeholder="专业" readonly></el-input>
                                                                                                                                                                                                      ...
                                                                                                                                                                                                      <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="面试问题" prop="mianshiwenti">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.mianshiwenti" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.mianshiwenti" label="面试问题" prop="mianshiwenti">
                    <span v-html="ruleForm.mianshiwenti"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
            ...
            ruleForm: {
                	        mianshibiaoti: '',
	                        	        ...
	                        	        zhuanye: '',
                                                                                                                                                                      ...
                                                                                                                                                                      rules: {
                  mianshibiaoti: [
                            { required: true, message: '面试标题不能为空', trigger: 'blur' },
                                    	                                                              ],
                  mianshiwenti: [
                                    	                                                              ],
                  mianshifujian: [
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.mianshibiaoti = true;
            continue;
	            	            ...
	            	            if(o=='mianshiwenti'){
            this.ruleForm.mianshiwenti = obj[o];
	    this.ro.mianshiwenti = true;
            continue;
          }
	            	            if(o=='mianshifujian'){
            this.ruleForm.mianshifujian = obj[o];
	    this.ro.mianshifujian = true;
            continue;
          }
	            	            if(o=='qiyebianhao'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `xianshangmianshi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xianshangmianshiCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    back() {
      ...
      this.parent.contentStyleChange();
                                                ...
                                                mianshifujianUploadChange(fileUrls) {
                this.ruleForm.mianshifujian = fileUrls;
				this.addEditUploadStyleChange()
            },
                                                                                                            	addEditStyleChange() {
	  this.$nextTick(()=>{
