<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="求职标题" prop="qiuzhibiaoti">
          <el-input v-model="ruleForm.qiuzhibiaoti" 
              placeholder="求职标题" clearable  :readonly="ro.qiuzhibiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="求职标题" prop="qiuzhibiaoti">
              <el-input v-model="ruleForm.qiuzhibiaoti" 
                placeholder="求职标题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tupian" label="图片" prop="tupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tupian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="期望职位" prop="qiwangzhiwei">
          <el-input v-model="ruleForm.qiwangzhiwei" 
              placeholder="期望职位" clearable  :readonly="ro.qiwangzhiwei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="期望职位" prop="qiwangzhiwei">
              <el-input v-model="ruleForm.qiwangzhiwei" 
                placeholder="期望职位" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="工作城市" prop="gongzuochengshi">
              <el-input v-model="ruleForm.gongzuochengshi" 
                placeholder="工作城市" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="薪资要求" prop="xinziyaoqiu">
          <el-select v-model="ruleForm.xinziyaoqiu" placeholder="请选择薪资要求">
            <el-option
                v-for="(item,index) in xinziyaoqiuOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
          ...
          <el-form-item class="input" label="邮箱" prop="youxiang">
              <el-input v-model="ruleForm.youxiang" 
                placeholder="邮箱" readonly></el-input>
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="求职内容" prop="qiuzhineirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.qiuzhineirong" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.qiuzhineirong" label="求职内容" prop="qiuzhineirong">
                    <span v-html="ruleForm.qiuzhineirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
            ...
            ruleForm: {
                	        qiuzhibiaoti: '',
	                        	        ...
	                        	        youxiang: '',
                                                              ...
                                                              rules: {
                  qiuzhibiaoti: [
                            { required: true, message: '求职标题不能为空', trigger: 'blur' },
                                    	                                                              ],
                  tupian: [
                                    	                                                              ],
                  qiwangzhiwei: [
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tupian = true;
            continue;
	            	            ...
	            	            if(o=='qiwangzhiwei'){
            this.ruleForm.qiwangzhiwei = obj[o];
	    this.ro.qiwangzhiwei = true;
            continue;
          }
	            	            if(o=='qiwangxingye'){
	    ...
	    this.ro.xinziyaoqiu = true;
            continue;
	            	            ...
	            	            if(o=='qiuzhineirong'){
            this.ruleForm.qiuzhineirong = obj[o];
	    this.ro.qiuzhineirong = true;
            continue;
          }
	            	            if(o=='yonghuming'){
