	...
	<div>
		<div class="container">
			<div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
				<h1 class="h1" style="color:rgba(25, 169, 123, 1);fontSize:28px;">毕业生信息招聘平台注册</h1>
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.qiyebianhao" class="input" type="text" placeholder="企业编号">
			   </div>
			 </div> -->
					<el-form-item label="企业编号" class="input" v-if="tableName=='qiye'">
						<el-input v-model="ruleForm.qiyebianhao" autocomplete="off" placeholder="企业编号" type="text" />
					</el-form-item>
					<!-- <div v-if="tableName=='qiye'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.guimo" class="input" type="text" placeholder="规模">
			   </div>
			 </div> -->
					<el-form-item label="规模" class="input" v-if="tableName=='qiye'">
						<el-input v-model="ruleForm.guimo" autocomplete="off" placeholder="规模" type="text" />
					</el-form-item>
					<!-- <div v-if="tableName=='qiye'" class="input-group">
			   <div class="label">性质</div>
			   <div class="input-container">
			     <input v-model="ruleForm.xingzhi" class="input" type="text" placeholder="性质">
			   </div>
			 </div> -->
					<el-form-item label="性质" class="input" v-if="tableName=='qiye'">
						<el-input v-model="ruleForm.xingzhi" autocomplete="off" placeholder="性质" type="text" />
					</el-form-item>
					<!-- <div v-if="tableName=='qiye'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.yonghuming" class="input" type="text" placeholder="用户名">
					...
					<el-form-item label="用户名" class="input" v-if="tableName=='biyesheng'">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.zhuanye" class="input" type="text" placeholder="专业">
					...
					<el-form-item label="专业" class="input" v-if="tableName=='biyesheng'">
...
<script>
	export default {
		...
		methods: {
			...
			// 注册
			login() {
				if ((!this.ruleForm.qiyebianhao) && `qiye` == this.tableName) {
				...
				if ((!this.ruleForm.yonghuming) && `biyesheng` == this.tableName) {
